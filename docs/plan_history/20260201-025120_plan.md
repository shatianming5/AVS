...
## Conclusions
- [ ] C0001: On AVE, under a strictly equal ViT token budget, Audio-anchored sampling improves segment-level accuracy vs Uniform sampling and Random anchors.
  ...
  - Evidence (anchor robustness knobs help on val but don’t transfer to test): `runs/REAL_AVE_20260131-211548/p0_train180_val165_energy_160_224_352_k2_shift1_std1p0_s0-4_rerun/metrics.json` (energy; 5 seeds; `anchored_top2.mean=0.245 > uniform.mean=0.242`) vs `runs/REAL_AVE_20260131-211548/p0_train180_test113_energy_160_224_352_k2_shift1_std1p0_s0-4/metrics.json` (energy; 5 seeds; `anchored_top2.mean=0.247 < uniform.mean=0.248`)
