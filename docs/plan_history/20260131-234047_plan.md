...
## Conclusions
- [x] C0001: On AVE, under a strictly equal ViT token budget, Audio-anchored sampling improves segment-level accuracy vs Uniform sampling and Random anchors.
  - Evidence required: `metrics.json` with `acc_mean±std` over ≥3 seeds for Uniform-224, Random-Top2, Audio-Top2; plus a statement that token budgets are equal.
  - Experiments: E0001
  - Artifacts: `runs/AVE_P0/*/metrics.json`
  - Evidence: `runs/E0001_ave_p0_real_20260131-040050/p0_energy_seedfix/metrics.json` (energy; 3 seeds; `anchored_top2.mean=0.756 > random_top2.mean=0.711 > uniform.mean=0.244`; `token_budget=1960`)
...
- [x] C0002: Audio-based anchors achieve higher Recall@K (and Recall@K,Δ) than random anchors on AVE.
  ...
  - Evidence: `runs/E0002_anchors_real_20260131-045200/anchor_eval/anchors_metrics.json` (energy; k=2; n=89; Δ=0: ours=0.207 > random=0.194)
