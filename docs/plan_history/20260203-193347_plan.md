...
- [ ] C0003: On official AVE test402, sampling-only anchored_top2 improves >= +2.0% with p<0.05 (SEEDS=0..9).
  ...
  - Experiments: E0012,E0018,E0019
  - Evidence (full; current best config does **not** meet the target): `runs/E0012_ave_p0_best_to_test_official_20260203-145743/metrics.json` (best=`base_160_224_352_k5`; anchored=0.7144 vs uniform=0.7123, Δ=+0.0021, p=0.593; `token_budget=1960`). Debug: anchors fallback to uniform on 294/402 clips, indicating Stage-1 confidence gating is too conservative for energy scores on test.
  - Evidence (full; tuning `anchor_std_threshold` improves but still does **not** meet the target): `runs/E0012_energy_k5_std0p9_test_full_20260203-153623/metrics.json` (same config but `anchor_std_threshold=0.9`; anchored=0.7196 vs uniform=0.7123, Δ=+0.0073, p=0.181; anchored vs random p=0.0067; fallback 272/402). Corresponding val402: `runs/E0011_energy_k5_std0p9_val_full_20260203-153634/metrics.json` (Δ=+0.0158, p=0.0023; fallback 269/401).
