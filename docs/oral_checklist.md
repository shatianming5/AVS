...
- [ ] **C0003 proven** on official AVE `test402`: `anchored_top2 - uniform ≥ +0.02`, paired `p < 0.05`, `SEEDS=0..9`.
  - Current best full test402 in this workspace is still short: `runs/E0628_full_test402_vecmlp_keepadj_adj2_shift1_std0p55_s0-9_20260210-225216/metrics.json` (Δ=+0.00883; p=0.225).
