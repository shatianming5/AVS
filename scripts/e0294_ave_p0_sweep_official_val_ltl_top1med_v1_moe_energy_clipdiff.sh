...
# E0294: Fixed-space sweep on official AVE val402 for learned anchors using:
#   EVENTNESS=moe_energy_clipdiff (Stage-1)
...
OUT_DIR="${OUT_DIR:-runs/E0294_ave_p0_sweep_official_val_${EVENTNESS}_${CANDIDATE_SET}_$(date +%Y%m%d-%H%M%S)}"
