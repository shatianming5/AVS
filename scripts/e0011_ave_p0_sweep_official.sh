...
# Fixed-space sweep on official AVE val402 to select a best config (for later test402 reproduction).
#
# Requires:
#   - official raw videos under data/AVE/raw/videos/<video_id>.mp4
#
# Produces:
#   - runs/E0011_*/sweep_summary.json
#   - runs/E0011_*/best_config.json
...
# Union of resolutions used by default candidates in `avs/experiments/ave_p0_sweep.py`.
...
OUT_DIR="${OUT_DIR:-runs/E0011_ave_p0_sweep_official_val_$(date +%Y%m%d-%H%M%S)}"
