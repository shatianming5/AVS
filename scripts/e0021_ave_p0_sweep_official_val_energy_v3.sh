...
# Fixed-space sweep (energy_v3) on official AVE val402 to select a best config
# for later test402 reproduction.
#
# Produces:
#   - runs/E0021_*/sweep_summary.json
#   - runs/E0021_*/best_config.json
...
# Union of resolutions used by energy_v3 candidates.
...
OUT_DIR="${OUT_DIR:-runs/E0021_ave_p0_sweep_official_val_energy_v3_$(date +%Y%m%d-%H%M%S)}"
