...
# E0235: Fixed-space sweep on official AVE val402 for learned anchors using `candidate_set=ltl_top1med_k1_v1`.
#
...
#   - defaults CANDIDATE_SET to ltl_top1med_k1_v1 (top1-med confidence gate + k=1)
#   - writes outputs under runs/E0235_*
...
OUT_DIR="${OUT_DIR:-runs/E0235_ave_p0_sweep_official_val_${EVENTNESS}_${CANDIDATE_SET}_$(date +%Y%m%d-%H%M%S)}"
