...
# E0367: Fixed-space sweep on official AVE val402 for AST-embedding + CLIPdiff learned anchors
# (`EVENTNESS=av_ast_clipdiff_mlp`) under the scale-invariant top1-med gate candidate set
...
OUT_DIR="${OUT_DIR:-runs/E0367_ave_p0_sweep_official_val_${EVENTNESS}_${CANDIDATE_SET}_$(date +%Y%m%d-%H%M%S)}"
