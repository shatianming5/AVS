...
# E0292: Fixed-space sweep on official AVE val402 for learned anchors using:
#   EVENTNESS=av_fused_clipdiff_prod (Stage-1)
...
OUT_DIR="${OUT_DIR:-runs/E0292_ave_p0_sweep_official_val_${EVENTNESS}_${CANDIDATE_SET}_$(date +%Y%m%d-%H%M%S)}"
