...
# E0370: Quick test402 transfer triage (SEEDS=0..2) for the E0318 winner (av_ast_clipalign_bce).
#
# Usage:
...
OUT_DIR="${OUT_DIR:-runs/E0370_quick_test402_${EVENTNESS}_$(date +%Y%m%d-%H%M%S)}"
