...
# E0352: Val402 sweep for CLAP audio-text prompt eventness (clap_evt).
#
# Usage:
#   AUDIO_DEVICE=cuda:0 TRAIN_DEVICE=cuda:0 bash scripts/e0352_ave_p0_sweep_official_val_ltl_top1med_norm_v1_clapevt.sh
#
# Produces:
#   - runs/E0352_*/sweep_summary.json
#   - runs/E0352_*/best_config.json
#   - runs/E0352_*/eventness_scores.json
...
OUT_DIR="${OUT_DIR:-runs/E0352_ave_p0_sweep_official_val_${EVENTNESS}_${CANDIDATE_SET}_$(date +%Y%m%d-%H%M%S)}"
export OUT_DIR
export EVENTNESS
